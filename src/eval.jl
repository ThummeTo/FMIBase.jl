...
"""
function (fmu::FMU)(; dx_refs::Union{AbstractVector{<:fmiValueReference}, Symbol}=:none, kwargs...)
...
- `ec::Union{AbstractVector{<:Real}, Nothing}`: The system event indicators (if ME-FMU, otherwise `nothing`).
"""
function (c::FMUInstance)(dx::AbstractVector{<:Real},
...
function (c::FMUInstance)(;dx::AbstractVector{<:Real}=c.default_dx,
